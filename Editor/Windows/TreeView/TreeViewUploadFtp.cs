...
namespace AIO.UEditor
{
    ...
    {
        public static TreeViewUploadFtp Create(ASBuildConfig.FTPConfig[] list)
        {
        ...
        private TreeViewUploadFtp(TreeViewState state, MultiColumnHeader header, ASBuildConfig.FTPConfig[] list) : base(state, header)
        {
            showAlternatingRowBackgrounds = false;
            Data                          = list;
        }

        public ASBuildConfig.FTPConfig[] Data;
        ...
        protected override void OnContextClicked(GenericMenu menu)
        {
            ...
            {
                Data = Data.Add(new ASBuildConfig.FTPConfig());
                Reload();
            });
        }
