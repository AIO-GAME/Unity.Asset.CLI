...
namespace YooAsset.Editor
{
    public class PackageImportWindow : EditorWindow
    {
        ...
        static void ShowWindow()
        {
            ...
            {
                _thisInstance =
                    EditorWindow.GetWindow(typeof(PackageImportWindow), false, "补丁包导入工具", true) as PackageImportWindow;
        ...
        private void CopyPackageFiles(string manifestFilePath)
        {
            ...
            }
            {
                ...
                string destPath =
                    $"{AssetBundleBuilderHelper.GetDefaultStreamingAssetsRoot()}/{_packageName}/{fileName}";
                EditorTools.CopyFile(sourcePath, destPath, true);
            }
