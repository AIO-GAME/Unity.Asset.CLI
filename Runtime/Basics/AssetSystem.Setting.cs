...
namespace AIO
{
    partial class AssetSystem
    {
        ...
        /// 添加白名单
        /// </summary>
        public static void AddWhite(params string[] list) { WhiteListLocal.AddRange(list); }

        /// <summary>
        /// 添加白名单
        /// </summary>
        public static void AddWhite(IEnumerable<string> list) { WhiteListLocal.AddRange(list); }
