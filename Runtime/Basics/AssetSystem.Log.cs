...
namespace AIO
{
    public partial class AssetSystem
    {
...
#if UNITY_EDITOR
                Debug.LogFormat($"<b><color=#9575CD>[ASSET]</color><color=#FFC107>[Warning]</color></b> {format}", args);
#else
        ...
        public static void LogException(string format, params object[] args)
        {
            if (Parameter.OutputLog)
#if UNITY_EDITOR
                Debug.LogFormat($"<b><color=#9575CD>[ASSET]</color><color=#E91E63>[Exception]</color></b> {format}", args);
#else
