...
namespace AIO.UEngine
{
    partial class ASProxy
    {
        ...
        public abstract TObject LoadAssetSync<TObject>(string location)
        ...
        public abstract IEnumerator LoadAssetCO<TObject>(string location, Action<TObject> cb)
        where TObject : Object;
        ...
        /// <typeparam name="TObject">资源类型</typeparam>
        /// <param name="location">资源的定位地址</param>
        public abstract Task<TObject> LoadAssetTask<TObject>(string location)
        where TObject : Object;
